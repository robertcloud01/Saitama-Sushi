            ...
            <div className="relative z-10 w-full max-w-md p-6">
                ...
                <div className="bg-[#111] border border-white/10 p-8 rounded-3xl shadow-2xl backdrop-blur-md">
                    ...
                    <form className="space-y-6">
                        ...
                        <button
                            className="w-full bg-[#ff2ca2] hover:bg-[#d9007e] text-white font-bold py-4 rounded-xl uppercase tracking-widest transition-all transform hover:scale-[1.02] shadow-[0_0_20px_rgba(255,44,162,0.3)] mt-4"
                        >
                            Entrar
                        </button>
                    </form>
                    ...
                    <div className="mt-8 pt-8 border-t border-white/5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button className="flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white py-3 rounded-lg transition-colors border border-white/5">
